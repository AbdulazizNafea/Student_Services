...
public class card_rest_password extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_card_rest_password);
        ...
        btn1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                else
                {
                    ...
                    intent.putExtra(Intent.EXTRA_SUBJECT, "اعادة تعيين كلمة السر");
