...
//----------------------------------------------------------------------------------------------
            ...
            public void onClick(View v)
            {
                ...
                else
                {
                    if (r1_1.isChecked() || r1_2.isChecked() || r1_3.isChecked()|| r1_3.isChecked())
                    {
                        ...
                        intent.putExtra(Intent.EXTRA_SUBJECT, "مشاكل في البلاك بورد");
                    ...
                    {
                        Toast.makeText(blackbord_page.this, "حدد المشكلة التي تواجهك", Toast.LENGTH_LONG).show();
    ...
    public void radio_button()
    {
        if (r1_1.isChecked())
        {
            r1 = "فقدت كلمة المرور أو اسم المستخدم";
        }
        else if (r1_2.isChecked())
        {
            r1 = "اختفت بعض المواد الدراسية";
        }
