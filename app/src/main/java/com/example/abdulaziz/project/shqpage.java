...
public class shqpage extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_shqpage);
...
//----------------------------------------------------------------------------------------------
        ...
        btn1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                else if (t_id.getText().toString().equals("")|| t_id.getText().length()<=9)
                {
                    t_id.setError("قم بكتابة رقم الهوية بشكل صحيح");
                }
                else if (t_idcollge.getText().toString().equals("") || t_idcollge.getText().length()<=8)
                {
                ...
                else
                {
                    ...
                    intent.putExtra(Intent.EXTRA_SUBJECT, "الشكاوى والإقتراحات");
