...
//----------------------------------------------------------------------------------------------
        ...
        btn1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    this_part.setError("قم بكتابة تخصصك الحالي");
                }
                else if (new_part.getText().toString().equals("")&& t_id.getText().length()<=10)
                {
                    new_part.setError("قم بكتابة التخخص الذي تريد التحويل له");
                }
                ...
                else
                {
                    ...
                    {
                        Toast.makeText(changepage.this,"قم بتحديد القسم الذي تنتمي له",Toast.LENGTH_LONG).show();
                    }
                }
